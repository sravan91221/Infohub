                    ...
                    <div class="col-md-9 register-right">
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                <h3 class="register-heading">Upload a material</h3>
                                <div class="row register-form">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="branchx" class="form-control" placeholder="Topic Name *" value="" />
                                        </div>
                                      <br />
                                        ...
                                        <div class="form-group" style={{width:"85%"}}>
                                          ...
                                          <option value="" disabled selected>Branch</option>
                                           ...
                                           <div class="form-group">
                                           <input type="file" name="imagex" accept=".pdf,.docx,.ppt"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="branchx" class="form-control" placeholder="Faculty Name *" value="" />
                                        </div>
